...
NOTE: this assets/ folder is not referenced by any live page — every real
<img src="...">, catalog.js entry, and CSS url() points at images/, not here.
It's a staging/backup copy (kept in sync with images/ where filenames match)
plus a few raw uploads that never made it into images/: 21x11tag.webp,
NFC-sticker-Tag.jpg, NFC21x11mm.jpeg, Ntag215_coin.jpeg, Ntag216_Card.jpeg,
NFC_Cards.jpg, UHF_RFID_Sticker_27x15mm_KU7.jpg, og-image.jpg (a ready-made
social-share image with no og:image meta tag pointing at it yet), logo.png.
